...
const MOCK_INPUT_DATA = [
    ...
    { _id: '2025-03-29T09:00:00Z', count: 3 },
    { _id: '2025-03-29T09:10:00Z', count: 3 },
    { _id: '2025-03-29T09:10:01Z', count: 3 },
];
...
async function loadWeeklyChart() {
    ...
    // 渲染图表
    renderEChart(labels, counts, 'Weekly Anxiety Count (Past 7 Days)');
}
